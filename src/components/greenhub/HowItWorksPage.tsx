  ...
  return (
    <div className="pt-24 pb-12">
      ...
      <section className="relative py-12 sm:py-16 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-[400px] h-[400px] md:w-[500px] md:h-[500px] bg-primary/10 rounded-full blur-[100px] md:blur-[120px]" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs sm:text-sm font-medium border border-primary/20 mb-6">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 justify-center mt-8">
              ...
              <Link
                href="/learn"
                className="glass glass-hover text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-medium text-sm sm:text-base"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="relative grid sm:grid-cols-3 gap-8 sm:gap-12">
            ...
            {steps.map((step, i) => (
              ...
              >
                <div className={`w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br ${step.color} to-transparent border border-white/10 flex items-center justify-center mb-6 sm:mb-8 relative z-10 glass group-hover:scale-110 transition-transform duration-500`}>
                ...
                <p className="text-sm sm:text-base text-gray-400 leading-relaxed max-w-sm mb-5 sm:mb-6">{step.description}</p>
      ...
      <section className="py-12 sm:py-20 relative bg-black">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Delivery Timeline</h2>
            <p className="text-sm sm:text-base text-gray-400">What happens after you place your order.</p>
          </div>
            ...
            {timeline.map((item, i) => (
              ...
              >
                ...
                <div className="flex items-start gap-4 md:hidden">
                  <div className="w-10 h-10 rounded-full bg-primary/20 border border-primary/40 flex items-center justify-center shrink-0 relative z-10 glass">
                    <item.Icon className="w-4 h-4 text-primary" />
                  </div>
                  <div className="flex-1 glass rounded-2xl p-4 min-w-0">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      <span className="text-primary text-xs font-bold bg-primary/10 px-2 py-0.5 rounded">{item.time}</span>
                ...
                <div className={`hidden md:flex items-center gap-6 ${i % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                  <div className="flex-1 glass rounded-2xl p-5 min-w-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
            {guarantees.map((g, i) => (
              <motion.div
                ...
                className="glass glass-hover rounded-2xl p-5 sm:p-6 text-center"
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <g.Icon className="w-6 h-6 sm:w-7 sm:h-7 text-primary" />
                </div>
                <h3 className="font-bold mb-2 text-base sm:text-lg">{g.title}</h3>
                <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">{g.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
