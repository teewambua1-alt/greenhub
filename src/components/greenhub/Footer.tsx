  ...
  return (
    <footer className="border-t border-white/10 bg-black pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex items-center gap-4">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="w-10 h-10 rounded-full glass flex items-center justify-center hover:bg-white/10 hover:text-primary transition-colors text-gray-400"
                >
        ...
        <p className="text-center text-[10px] text-gray-600 mt-6 max-w-3xl mx-auto leading-relaxed">
