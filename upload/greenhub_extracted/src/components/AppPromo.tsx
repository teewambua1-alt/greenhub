        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="w-[300px] h-[600px] rounded-[3rem] border-[8px] border-white/10 bg-black relative overflow-hidden glass shadow-2xl z-10 flex flex-col">
              ...
              <div className="flex-1 p-6 pt-12 flex flex-col gap-4">
                ...
                <div className="h-32 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-transparent border border-emerald-500/30"></div>
                ...
                <div className="h-6 w-1/2 bg-white/10 rounded-md mt-4"></div>
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
              Take GreenHub <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">Anywhere You Go</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <button className="flex items-center justify-center gap-3 glass px-6 py-3 rounded-xl hover:bg-white/10 transition-colors border-white/20">
